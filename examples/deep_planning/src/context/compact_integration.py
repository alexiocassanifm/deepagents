...
# Simplified imports - LLM compression removed
...
"""
    ...
    def _analyze_conversation_content(self, messages: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Analizza contenuto usando pattern-matching analysis."""
        # Use pattern-based analysis directly (LLM compression removed)
